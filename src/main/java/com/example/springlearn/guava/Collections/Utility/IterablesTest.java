...
public class IterablesTest {
    ...
    public static void main(String[] args) {
         ...
         * 根据条件过滤集合
         */
        Iterables.removeIf(list1, new Predicate<String>() {
            @Override
        ...
        System.out.println("根据条件过滤集合："+list1);


        /**
         * 集合间差集
         */
        List<String> list3 = Lists.newArrayList("one", "two");
        List<String> list4 = Lists.newArrayList("two");
        boolean b = Iterables.removeAll(list3, list4);
        System.out.println("集合间差集："+ Joiner.on(",").join(list3));
